...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Không phát sinh chi phi ẩn! Bảng giá trọn gói đã bao gồm toàn bộ phí duy trì phần mềm, quyền cập nhật nâng cấp tính năng mới và quá trình kỹ thuật viên hỗ trợ chuẩn 1-1 qua Ultraview trọn đời.'
    },
    {
  ...
  return (
    <section id="faq" className="py-20 lg:py-24 bg-white border-b border-rose-50/20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="font-sans font-extrabold text-2xl sm:text-3xl text-slate-900 tracking-tight flex items-center justify-center gap-2">
            <HelpCircle className="w-6.5 h-6.5 text-[#ff6b00]" />
        ...
        <div className="space-y-4">
          {faqs.map((f, idx) => {
            ...
            return (
              <div 
                key={idx}
                className="bg-slate-50 border border-slate-150 rounded-2xl p-5 sm:p-6 transition-all"
              >
                <button

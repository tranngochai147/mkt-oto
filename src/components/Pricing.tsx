    ...
    <section id="pricing" className="py-20 lg:py-28 bg-white border-b border-slate-100">
      <div className="max-w-[1440px] mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto items-stretch">
          ...
          <div className="p-8 rounded-3xl border border-slate-200/80 hover:border-[#ff6b00]/30 hover:shadow-xl transition-all flex flex-col h-full bg-white">
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl border border-[#ff6b00] text-[#ff6b00] hover:bg-orange-50 font-bold tracking-wide transition-all active:scale-98 cursor-pointer text-center text-sm"
            >
              Đăng Ký Ngay
            </button>
          </div>

          {/* Card 2: COMBO FULL (Phố biến nhất) */}
          <div className="p-8 rounded-3xl border-[4px] border-[#ff6b00] bg-orange-500/5 flex flex-col relative md:scale-105 shadow-2xl z-10">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#ff6b00] text-white px-4 py-1.5 rounded-full text-xs font-sans font-black uppercase tracking-widest flex items-center gap-1 shadow-md">
              <Stars className="w-3.5 h-3.5" fill="currentColor" />
              Phổ biến nhất
            </div>
            
            <h4 className="font-sans font-extrabold text-2xl text-slate-950 mb-2 mt-2">COMBO FULL GIẢI PHÁP</h4>
            <p className="text-[#ff6b00] text-xs font-black uppercase tracking-wider mb-6">Trọn Bộ Công Cụ Vượt Trội</p>
            
            <div className="text-[#ff6b00] font-sans font-black text-4xl sm:text-5xl mb-6">
              9.000.000
            ...
            <ul className="space-y-4 mb-8 flex-grow">
              <li className="flex gap-2.5 text-sm font-bold text-slate-950">
                <Stars className="w-5 h-5 text-[#ff6b00] fill-orange-100 shrink-0" /> 
            ...
            <button
              ...
              className="w-full py-4 rounded-xl bg-[#ff6b00] text-white hover:bg-orange-600 hover:shadow-lg active:scale-98 font-bold text-center tracking-wider text-sm transition-all shadow-md cursor-pointer"
            >
              NHẬN ƯU ĐÃI NGAY
            </button>
          </div>
        ...
        {/* Promotion Banner */}
        <div className="mt-16 bg-orange-500/10 p-8 rounded-3xl border-2 border-[#ff6b00]/20 max-w-5xl mx-auto shadow-sm">
          <h5 className="font-sans font-black text-center text-lg sm:text-xl text-[#ff6b00] mb-6 flex items-center justify-center gap-2">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 sm:gap-12 items-start sm:items-center">
            ...
            <div className="flex items-center gap-3 font-sans font-bold text-slate-800 text-sm sm:text-base">
              <span className="w-8 h-8 rounded-full bg-[#ff6b00] text-white flex items-center justify-center text-sm">✓</span>
